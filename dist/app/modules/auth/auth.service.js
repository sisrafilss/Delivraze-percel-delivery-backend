...
const updateProfile = (payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    const ifUserExist = yield user_model_1.User.findById(decodedToken.userId);
    if (!ifUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.NOT_FOUND, "User Not Found");
    }
    const updatedProfile = yield user_model_1.User.findByIdAndUpdate(ifUserExist._id, payload, {
        new: true,
        runValidators: true,
    });
