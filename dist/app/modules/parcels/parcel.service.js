...
const getIncommingParcelsByReceiver = (decodedToken, query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedQuery = Object.assign(Object.assign({}, query), { receiverEmail: decodedToken.email, status: {
            $in: [
                parcel_interface_1.ParcelStatus.IN_TRANSIT,
                parcel_interface_1.ParcelStatus.ACCEPTED,
...
const confirmDeliveryByReceiver = (decodedToken, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (decodedToken.email !== payload.receiverEmail) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, `Credential doesn't match. Check the user email in the request body`);
    }
